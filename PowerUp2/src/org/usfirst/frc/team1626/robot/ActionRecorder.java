...
public class ActionRecorder
{
	...
	public int nameIndex(String selector) {
		String swit = selector.substring(0, 1);
		String scal = selector.substring(1, 2);
	...
	public void displayNames()
	{
		for (String fieldString: autoFileIndex.keySet()) {
			...
			SmartDashboard.putString("DB/String " + nameIndex(fieldString), fieldString + ":" + name);
		}
	}
